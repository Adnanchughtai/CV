...
''')
txt('Comparison of effective dose with deterrence time of three essential oils by using multichamber blood feeding system (MCBF) against *Aedes aegypti*', 'Processing') 
